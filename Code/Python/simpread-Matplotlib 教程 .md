> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://liam.page/2014/09/11/matplotlib-tutorial-zh-cn/
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/exercice_1.png)](/uploads/teaching/matplotlib/scripts/exercice_1.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/exercice_3.png)](/uploads/teaching/matplotlib/scripts/exercice_3.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/exercice_6.png)](/uploads/teaching/matplotlib/scripts/exercice_6.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/exercice_9.png)](/uploads/teaching/matplotlib/scripts/exercice_9.py)
...
### [](#图像、子图、坐标轴和记号 "图像、子图、坐标轴和记号")图像、子图、坐标轴和记号
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/subplot-vertical.png)](/uploads/teaching/matplotlib/scripts/subplot-vertical.py)
...
##### [](#Tick-Locators "Tick Locators")Tick Locators
...
![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-NullLocator.png) |
| IndexLocator | 

Place a tick on every multiple of some base number of points plotted.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-IndexLocator.png) |
| FixedLocator | 

Tick locations are fixed.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-FixedLocator.png) |
| LinearLocator | 

Determine the tick locations.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-LinearLocator.png) |
| MultipleLocator | 

Set a tick on every integer that is multiple of some base.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-MultipleLocator.png) |
| AutoLocator | 

Select no more than n intervals at nice locations.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-AutoLocator.png) |
| LogLocator | 

Determine the tick locations for log axes.

![](https://liam.page/uploads/teaching/matplotlib/figures/ticks-LogLocator.png) |
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/plot_ex.png)](/uploads/teaching/matplotlib/scripts/plot_ex.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/scatter_ex.png)](/uploads/teaching/matplotlib/scripts/scatter_ex.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/bar_ex.png)](/uploads/teaching/matplotlib/scripts/bar_ex.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/contour_ex.png)](/uploads/teaching/matplotlib/scripts/contour_ex.py)

#### [](#灰度图（Imshow） "灰度图（Imshow）")灰度图（Imshow）
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/pie_ex.png)](/uploads/teaching/matplotlib/scripts/pie_ex.py)

#### [](#量场图（Quiver-Plots） "量场图（Quiver Plots）")量场图（Quiver Plots）
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/quiver_ex.png)](/uploads/teaching/matplotlib/scripts/quiver_ex.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/grid_ex.png)](/uploads/teaching/matplotlib/scripts/grid_ex.py)
...
[![](https://liam.page/uploads/teaching/matplotlib/figures/plot3d_ex.png)](/uploads/teaching/matplotlib/scripts/plot3d_ex.py)
...
#### [](#Matplotlib-文档 "Matplotlib 文档")Matplotlib 文档
